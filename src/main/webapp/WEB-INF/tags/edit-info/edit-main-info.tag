...
<form action="#" method="post" onsubmit="validateDateBirth(this);" >

<ul class="list-group">

	<li class="list-group-item"><h3>Richard Hendricks</h3></li>
	...
	<div class="row" >
		...
		<div class="col-md-5">
		<p>1. Фотография может многое рассказать о кандидате</p> 
		<p>2. Размер файла должен быть не меньше чем 400 на 400</p> 
		<p>3. Файл должен быть в формате jpg</p>
		</div>
		</div>
	...
	<div class="row" >
		<div class="col-md-7" >
			...
			Дата рождения* <input type="text" name="edit-main-info-date" id="edit-main-info-date" />
<script type="text/javascript">
	...
	<div class="row" >
		<div class="col-md-7" >
			...
			Страна* <input type="text" name="edit-main-info-country" id="edit-main-info-country" />
	...
	<div class="row" >
		<div class="col-md-7" >
			...
			Город* <input type="text" name="edit-main-info-city" id="edit-main-info-city" />
	...
	<div class="row" >
		<div class="col-md-7" >
			...
			Email* <input type="text" name="edit-main-info-email" id="edit-main-info-email" />

		</div>
		<div class="col-md-5">
			<p>1. Как указано в загранпаспорте</p>
		</div>
		</div>
	...
	<div class="row" >
		<div class="col-md-7" >
			...
			Телефон* <input type="text" name="edit-main-info-phone" id="edit-main-info-phone" />

		</div>
		<div class="col-md-5">
			<p>В формате Е.164, например, +380501234567</p>
		</div>
		</div>
	...
	<div class="row" >
		<div class="col-md-7" >
			...
			Желаемая должность* <input type="text" name="edit-main-info-position" id="edit-main-info-position" />

		</div>
		<div class="col-md-5">
			<p>Указать кратко и понятно</p>
		</div>
		</div>
	...
	<div class="row" >
		<div class="col-md-7" >
			...
			Ваша квалификация* <input type="text" name="edit-main-info-qualification" id="edit-main-info-qualification" />

		</div>
		<div class="col-md-5">
			<p>Описать Ваш опыт, курсы</p>
		</div>
		</div>
...
function myFunction() {
	...
	/*var imgSrc = document.getElementById("filePath").files[0].name; 
	alert(imgSrc);
	document.getElementById("photo").setAttribute("src", "/media/avatar/"+imgSrc);
...
<script>
function validateDateBirth(form) {
